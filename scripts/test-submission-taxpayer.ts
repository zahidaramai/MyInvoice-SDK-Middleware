 ...
 * Using TAXPAYER mode (no onbehalfof header) since the document supplier matches the client credentials
 */
...
async function getToken(): Promise<string> {
  ...
  console.log("Getting token for TAXPAYER mode (no onbehalfof)...");
...
async function submitDocument(
  ...
  console.log("\nRequest details:");
  console.log("  URL:", url);
  console.log("  Headers: Authorization: Bearer <token> (no onbehalfof)");
