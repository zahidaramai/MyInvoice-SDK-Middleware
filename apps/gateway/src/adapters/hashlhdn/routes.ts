 ...
 * Example: "BP-12ys8Uy4" for "B Point Station"
 */
...
/**
 * Register HashLHDN routes
 */
export async function hashlhdnRoutes(fastify: FastifyInstance): Promise<void> {
  // Apply authentication to all routes
  fastify.addHook("preHandler", authenticate);
  fastify.addHook("preHandler", requirePermission("submit:invoice"));

  /**
   * POST /api/v1/hashlhdn/submit-consolidate
  ...
  /**
   * POST /api/v1/hashlhdn/submit-justsave
  ...
  /**
   * POST /api/v1/hashlhdn/submit-personal
  ...
  /**
   * GET /api/v1/hashlhdn/invoices/:trackingId
  ...
  /**
   * GET /api/v1/hashlhdn/invoices/share-link
  ...
  /**
   * DELETE /api/v1/hashlhdn/invoices/:trackingId
  ...
  /**
   * PUT /api/v1/hashlhdn/invoices/:trackingId/purge
  ...
  /**
   * PUT /api/v1/hashlhdn/invoices/purge-by-id/:id
