/**
 * KLCubeLHDN to UBL 2.1 Transformer
 * Converts simplified KLCubeLHDN JSON format to MyInvois UBL 2.1 JSON
 */
...
/**
 * Map KLCubeLHDN tax codes to MyInvois tax type codes
 */
...
/**
 * Map KLCubeLHDN state codes to Malaysian state codes
 */
...
/**
 * Map KLCubeLHDN ID types to PartyIdScheme
 */
...
/**
 * Transform KLCubeLHDN invoice(s) to UBL 2.1 v1.0 format
 */
...
/**
 * Transform KLCubeLHDN invoice(s) to UBL 2.1 v1.1 format (with signature support)
 */
