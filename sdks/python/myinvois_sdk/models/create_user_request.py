...
class CreateUserRequest(BaseModel):
    ...
    company_ids: Optional[List[StrictStr]] = Field(default=None, alias="companyIds")
    __properties: ClassVar[List[str]] = ["email", "password", "name", "roleId", "companyIds"]
