...
class InvoiceItem(BaseModel):
    ...
    discount: Optional[Union[StrictFloat, StrictInt]] = 0
    tax_code: StrictStr = Field(description="Tax code (01=SST, 02=Service Tax, E=Exempt)", alias="taxCode")
    tax_rate: Union[StrictFloat, StrictInt] = Field(alias="taxRate")
    tax_amount: Union[StrictFloat, StrictInt] = Field(alias="taxAmount")
    total: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["description", "quantity", "unitPrice", "discount", "taxCode", "taxRate", "taxAmount", "total"]
