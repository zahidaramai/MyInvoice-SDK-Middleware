...
class SubmissionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trackingId", "invoiceId", "status", "message", "submittedAt"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['DRAFT', 'SUBMITTED', 'VALID', 'INVALID', 'CANCELLED']):
            raise ValueError("must be one of enum values ('DRAFT', 'SUBMITTED', 'VALID', 'INVALID', 'CANCELLED')")
        return value
