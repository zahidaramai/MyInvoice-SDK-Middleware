...
class SubmitJustSaveRequest(BaseModel):
    """
    SubmitJustSaveRequest
    """ # noqa: E501
    company_id: StrictStr = Field(alias="companyId")
    invoice: Invoice
    __properties: ClassVar[List[str]] = ["companyId", "invoice"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitJustSaveRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitJustSaveRequest from a dict"""
        if obj is None:
            return None
