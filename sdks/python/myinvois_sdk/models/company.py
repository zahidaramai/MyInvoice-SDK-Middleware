...
class Company(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "tin", "idType", "idValue", "address", "city", "state", "postalCode", "phone", "email", "isActive", "myinvoisEnv", "hasCredentials", "createdAt", "updatedAt"]
