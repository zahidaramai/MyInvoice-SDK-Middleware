...
class DocumentListResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["trackingId", "invoiceNumber", "invoiceDate", "invoiceType", "status", "myinvoisUuid", "total", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentListResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentListResponseDataInner from a dict"""
        if obj is None:
            return None
