...
class SubmitBuyerRequestInvoice(BaseModel):
    """
    ...
    rounding: Union[StrictFloat, StrictInt]
    tax_amount: Union[StrictFloat, StrictInt] = Field(alias="taxAmount")
    total: Union[StrictFloat, StrictInt]
    buyer: BuyerInfo
    items: List[InvoiceItem]
    __properties: ClassVar[List[str]] = ["invoiceNumber", "invoiceDate", "amount", "discount", "rounding", "taxAmount", "total", "buyer", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitBuyerRequestInvoice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitBuyerRequestInvoice from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "buyer": BuyerInfo.from_dict(obj["buyer"]) if obj.get("buyer") is not None else None,
