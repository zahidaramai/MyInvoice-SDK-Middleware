...
class LoginResponse(BaseModel):
    ...
    expires_in: Optional[StrictInt] = Field(default=None, description="Access token expiry in seconds", alias="expiresIn")
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["accessToken", "refreshToken", "expiresIn", "user"]
