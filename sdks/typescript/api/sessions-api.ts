...
export const SessionsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteSession: async (
      ...
      const localVarPath = `/v1/sessions/{sessionId}`.replace(
        `{${"sessionId"}}`,
  ...
  return {
    ...
    async createSession(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["SessionsApi.createSession"]?.[localVarOperationServerIndex]?.url;
    ...
    async deleteSession(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SessionsApi.deleteSession"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getSession(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SessionsApi.getSession"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const SessionsApiFactory = function (
  ...
  return {
     ...
     */
    createSession(
      requestParameters: SessionsApiCreateSessionRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Session> {
      return localVarFp
        .createSession(requestParameters.sessionCreateRequest, options)
    ...
    deleteSession(
      ...
      return localVarFp
        .deleteSession(requestParameters.sessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Returns session metadata (no secrets)
    ...
    getSession(
      ...
      return localVarFp
        .getSession(requestParameters.sessionId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
