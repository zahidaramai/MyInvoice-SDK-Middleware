...
export const RolesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteRole: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/roles/{id}`.replace(
        `{${"id"}}`,
    ...
    updateRolePermissions: async (
      ...
      const localVarPath = `/api/v1/roles/{id}/permissions`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const RolesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async listAllRoles(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListAllRoles200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listAllRoles(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RolesApi.listAllRoles"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async listPermissions(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListPermissions200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listPermissions(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RolesApi.listPermissions"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async listRoles(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoleListResponse>> {
    ...
    async updateRolePermissions(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateRolePermissions(
        id,
        updateRolePermissionsRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RolesApi.updateRolePermissions"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const RolesApiFactory = function (
  ...
  return {
    ...
    createRole(
      ...
      return localVarFp
        .createRole(requestParameters.createRoleRequest, options)
    ...
    deleteRole(
      ...
      return localVarFp
        .deleteRole(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Retrieve role details including assigned permissions
    ...
    getRole(
      ...
      return localVarFp
        .getRole(requestParameters.id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Returns all roles without pagination for dropdowns and selectors
    ...
    updateRole(
      ...
      return localVarFp
        .updateRole(requestParameters.id, requestParameters.updateRoleRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Replace the permissions assigned to a role
     ...
     */
    updateRolePermissions(
      requestParameters: RolesApiUpdateRolePermissionsRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Role> {
      return localVarFp
        .updateRolePermissions(
          requestParameters.id,
          requestParameters.updateRolePermissionsRequest,
          options
        )
        .then((request) => request(axios, basePath));
    },
