  ...
  return {
    ...
    async getCurrentUser(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["AuthenticationApi.getCurrentUser"]?.[localVarOperationServerIndex]?.url;
    ...
    async logout(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthenticationApi.logout"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async switchCompany(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.switchCompany(
        switchCompanyRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AuthenticationApi.switchCompany"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const AuthenticationApiFactory = function (
  ...
  return {
    ...
    refreshToken(
      ...
      return localVarFp
        .refreshToken(requestParameters.refreshRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Switch to a different company context
     ...
     */
    switchCompany(
      requestParameters: AuthenticationApiSwitchCompanyRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<LoginResponse> {
      return localVarFp
        .switchCompany(requestParameters.switchCompanyRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
