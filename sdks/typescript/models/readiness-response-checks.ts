...
export type ReadinessResponseChecksDatabaseEnum =
  (typeof ReadinessResponseChecksDatabaseEnum)[keyof typeof ReadinessResponseChecksDatabaseEnum];
export const ReadinessResponseChecksRedisEnum = {
  Ok: "ok",
  Error: "error",
} as const;

export type ReadinessResponseChecksRedisEnum =
  (typeof ReadinessResponseChecksRedisEnum)[keyof typeof ReadinessResponseChecksRedisEnum];
