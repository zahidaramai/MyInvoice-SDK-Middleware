...
export type CreateCompanyRequestIdTypeEnum =
  (typeof CreateCompanyRequestIdTypeEnum)[keyof typeof CreateCompanyRequestIdTypeEnum];
export const CreateCompanyRequestMyinvoisEnvEnum = {
  Sandbox: "SANDBOX",
  Prod: "PROD",
} as const;

export type CreateCompanyRequestMyinvoisEnvEnum =
  (typeof CreateCompanyRequestMyinvoisEnvEnum)[keyof typeof CreateCompanyRequestMyinvoisEnvEnum];
