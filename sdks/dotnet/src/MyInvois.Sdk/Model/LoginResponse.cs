...
namespace MyInvois.Sdk.Model
{
    ...
    public partial class LoginResponse : IValidatableObject
    {
        ...
        /// <param name="expiresIn">Access token expiry in seconds.</param>
        /// <param name="user">user.</param>
        public LoginResponse(string accessToken = default(string), string refreshToken = default(string), int expiresIn = default(int), User user = default(User))
        {
        ...
        /// </summary>
        /// <value>Access token expiry in seconds</value>
