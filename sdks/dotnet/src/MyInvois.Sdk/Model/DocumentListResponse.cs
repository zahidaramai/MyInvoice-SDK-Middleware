...
namespace MyInvois.Sdk.Model
{
    ...
    public partial class DocumentListResponse : IValidatableObject
    {
        ...
        public DocumentListResponse(List<DocumentListResponseDataInner> data = default(List<DocumentListResponseDataInner>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<DocumentListResponseDataInner> Data { get; set; }
