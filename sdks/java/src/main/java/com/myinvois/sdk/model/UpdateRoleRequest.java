 ...
 */
@JsonPropertyOrder({
  UpdateRoleRequest.JSON_PROPERTY_NAME,
...
public class UpdateRoleRequest {
  ...
  public UpdateRoleRequest name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateRoleRequest description(@jakarta.annotation.Nullable String description) {
  ...
  public UpdateRoleRequest permissions(@jakarta.annotation.Nullable List<String> permissions) {
